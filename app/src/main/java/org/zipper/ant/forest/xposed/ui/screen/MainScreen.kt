...
fun MainScreen(
    ...
    val mainState = rememberMainAppState()
    var showSettingsDialog by rememberSaveable { mutableStateOf(false) }
    val currentTopLevelDestination = mainState.currentTopLevelDestination
    ...
    CompositionLocalProvider(
        ...
        LocalMainAppState provides mainState
    ) {
        Scaffold(
            ...
            bottomBar = { BottomNavigation(mainState) },
